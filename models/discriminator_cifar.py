...
class _netD_CIFAR10_SN(nn.Module):
    def __init__(self, ngpu, num_classes=10):
        super(_netD_CIFAR10_SN, self).__init__()
        self.ngpu = ngpu
        print("INFO: discriminator on CIFAR10 with Spectral Normalication")
        ...
        # Convolution 2
        self.conv2 = nn.Sequential(
            spectral_norm(nn.Conv2d(16, 32, 3, 1, 1, bias=False)),
            nn.LeakyReLU(0.2, inplace=True),
            nn.Dropout(0.5, inplace=False),
        )
        # Convolution 3
